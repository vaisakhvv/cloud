...
public class DataBase extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String pwd      = request.getParameter("contact_message");
          ...
          try{   
                ...
                Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost\\VIMPLES\\SQLEXPRESS:1433;databaseName=CLOUD","vaisakh","vaisakh44");
                
                Statement stmt = con.createStatement(); 
                
                stmt.executeUpdate("insert into Register values('"+name+"','"+email+"','"+pwd+"','"+location+"')");
